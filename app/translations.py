...
TRANSLATIONS = {
    ...
    "es": {
        "app_title": "🏢 SaaS de Ventas",
        "menu": "Menú",
        "select_page": "Seleccionar página",
        "pre_advice": "Consejo previo",
        "post_review": "Revisión posterior",
        "icebreaker": "Rompehielos",
        "history": "Historial",
        "settings": "Configuración y personalización",
        "search_enhancement": "Búsqueda avanzada",
        "quickstart_mode": "Modo de inicio rápido",
        "quickstart_help": "Mostrar solo entradas esenciales",
        "sidebar_toggle_label": "☰ Menú",
        "sidebar_toggle_help": "Mostrar u ocultar la barra lateral",
        "tab_navigation_hint": "Use las pestañas de abajo para cambiar de página",
        "fill_later": "Completar después",
        "later_help": "Los campos opcionales se pueden editar más tarde",
        "tutorial_title": "Bienvenido a Sales SaaS",
        "tutorial_message": "Este breve tutorial te ayudará a comenzar. Puedes mostrarlo de nuevo desde Configuración.",
        "tutorial_close": "Comenzar",
        "show_tutorial_on_start": "Mostrar tutorial al inicio",
        "show_tutorial_on_start_help": "Mostrar una breve guía al iniciar la aplicación",
        "show_tutorial_again": "Mostrar tutorial ahora",

        "pre_advice_header": "Consejo previo",
        "pre_advice_desc": "Apoya tu preparación antes de las reuniones. Proporciona tipo de venta, industria e información del producto.",
        "input_form_tab": "Formulario",
        "icebreaker_tab": "Rompehielos",

        "post_review_header": "🔍 Análisis posterior a la reunión",
        "post_review_desc": "Analiza notas de reuniones para generar mejoras y próximas acciones.",

        "icebreaker_header": "🎯 Generador de rompehielos",
        "icebreaker_desc": "Genera rompehielos naturales según el tipo de venta y la industria.",
        ...
        "search_enhancement_title": "🔍 Mejora de búsqueda",
        "search_enhancement_desc": "Aprovecha el conocimiento de LLM para mejorar la calidad y la puntuación de la búsqueda.",

        "settings_page_title": "⚙️ Configuración y personalización",
        "settings_page_desc": "Personaliza cómo funciona la aplicación.",
        "tab_llm": "🤖 Configuración de LLM",
        "tab_search": "🔍 Configuración de búsqueda",
        "tab_ui": "🎨 Configuración de UI",
        "tab_data": "💾 Configuración de datos",
        "tab_import_export": "📁 Importar/Exportar",
        "tab_crm": "🔗 Integración CRM",
        "language_setting": "Idioma",
        "language_setting_help": "Idioma de la aplicación",
        ...
        "crm_section_title": "🔗 Integración CRM",
        ...
        "crm_enable": "Habilitar integración CRM",
        "crm_enable_help": "Permitir cargar información de clientes desde el CRM",
