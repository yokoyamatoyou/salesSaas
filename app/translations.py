...
TRANSLATIONS = {
    "ja": {
        ...
        "tutorial_title": "ようこそ Sales SaaS へ",
        "tutorial_message": "このアプリの使い方を簡単に紹介します。設定ページからいつでも再表示できます。",
        "tutorial_close": "はじめる",
        "show_tutorial_on_start": "起動時にチュートリアルを表示",
        "show_tutorial_on_start_help": "次回起動時に簡単なガイドを表示します",
        "show_tutorial_again": "チュートリアルを今すぐ表示",
